...
import '../../core/session/presentation/session_bloc.dart' as _i82;
import '../../features/addresses/presentation/bloc/address_cubit.dart' as _i87;
...
import '../../features/order_tracking/presentation/bloc/order_tracking_cubit.dart'
    as _i68;
import '../../features/otp_payments/data/otp_payment_repo_imp.dart' as _i70;
import '../../features/otp_payments/domain/otp_payment_repo.dart' as _i69;
...
import '../../features/payment/presentation/bloc/payment_cubit.dart' as _i71;
import '../../features/products/data/products_repository_impl.dart' as _i73;
import '../../features/products/domain/products_repository.dart' as _i72;
import '../../features/products/presentation/cubit/product_cubit.dart' as _i93;
...
import '../../features/reset_password/presentation/cubit/reset_pass_cubit.dart'
    as _i76;
import '../../features/sahay_payment/data/sahay_pay_repo_impl.dart' as _i78;
import '../../features/sahay_payment/domain/sahay_pay_repo.dart' as _i77;
...
import '../data/db/database_module.dart' as _i95;
import '../data/network/api_provider.dart' as _i20;
import '../data/network/dio_client.dart' as _i96;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i69.OtpPaymentRepo>(() => _i70.OtpPaymentRepoImp(
        gh<_i20.ApiProvider>(),
        gh<_i15.PrefsData>(),
        gh<_i4.CartDao>(),
        gh<_i35.SessionRepo>(),
      ));
  gh.factory<_i71.PaymentCubit>(() => _i71.PaymentCubit(
        gh<_i31.PaymentRepo>(),
        gh<_i63.CustomerLoanRepo>(),
      ));
  gh.factory<_i72.ProductRepository>(() => _i73.ProductsRepositoryImpl(
        gh<_i35.SessionRepo>(),
        gh<_i20.ApiProvider>(),
      ));
  gh.factory<_i74.RedirectedPaymentRepo>(() => _i75.RedirectedPaymentRepoImp(
        apiProvider: gh<_i20.ApiProvider>(),
        prefsData: gh<_i15.PrefsData>(),
        cartDao: gh<_i4.CartDao>(),
        sessionRepo: gh<_i35.SessionRepo>(),
      ));
  gh.factory<_i76.ResetPassCubit>(() => _i76.ResetPassCubit(
        gh<_i33.ResetPassRepo>(),
        gh<_i13.PhoneNumberUtils>(),
      ));
  gh.factory<_i77.SahayPayRepo>(() => _i78.SahayPayRepoImpl(
        gh<_i20.ApiProvider>(),
        gh<_i15.PrefsData>(),
        gh<_i4.CartDao>(),
        gh<_i35.SessionRepo>(),
      ));
  gh.factory<_i79.SahayPaymentCubit>(() => _i79.SahayPaymentCubit(
        gh<_i77.SahayPayRepo>(),
        gh<_i13.PhoneNumberUtils>(),
      ));
  gh.factory<_i80.SelectedProductRepo>(
      () => _i81.SelectedProductPageRepositoryImpl(
            gh<_i35.SessionRepo>(),
            gh<_i20.ApiProvider>(),
          ));
  gh.factory<_i82.SessionCubit>(() => _i82.SessionCubit(
        gh<_i35.SessionRepo>(),
        gh<_i9.DeviceInfo>(),
      ));
  gh.factory<_i83.SpecialOrderCubit>(
      () => _i83.SpecialOrderCubit(gh<_i39.SpecialOrderRepo>()));
  gh.factory<_i84.SubCategoryCubit>(() => _i84.SubCategoryCubit(
      subCategoryRepository: gh<_i41.SubCategoryRepository>()));
  gh.factory<_i85.UserRegistrationCubit>(() => _i85.UserRegistrationCubit(
        gh<_i47.UserRegistrationRepo>(),
        gh<_i13.PhoneNumberUtils>(),
      ));
  gh.factory<_i86.ValidateCubit>(
      () => _i86.ValidateCubit(gh<_i50.ValidateRepo>()));
  gh.factory<_i87.AddressCubit>(
      () => _i87.AddressCubit(gh<_i52.AddressRepo>()));
  gh.factory<_i88.CashPaymentCubit>(() => _i88.CashPaymentCubit(
        gh<_i55.CashPaymentRepo>(),
        gh<_i13.PhoneNumberUtils>(),
      ));
  gh.factory<_i89.CategoriesCubit>(
      () => _i89.CategoriesCubit(categoriesRepo: gh<_i57.CategoriesRepo>()));
  gh.factory<_i90.CheckOutCubit>(() => _i90.CheckOutCubit(
        gh<_i60.CheckOutRepo>(),
        gh<_i5.CartRepository>(),
        gh<_i35.SessionRepo>(),
      ));
  gh.factory<_i91.CustomerLoanCubit>(() => _i91.CustomerLoanCubit(
        gh<_i5.CartRepository>(),
        gh<_i63.CustomerLoanRepo>(),
      ));
  gh.factory<_i92.OtpPaymentCubit>(() => _i92.OtpPaymentCubit(
        gh<_i69.OtpPaymentRepo>(),
        gh<_i13.PhoneNumberUtils>(),
      ));
  gh.factory<_i93.ProductCubit>(
      () => _i93.ProductCubit(productRepository: gh<_i72.ProductRepository>()));
  gh.factory<_i94.SelectedProductCubit>(
      () => _i94.SelectedProductCubit(gh<_i80.SelectedProductRepo>()));
  return getIt;
}

class _$DatabaseNodule extends _i95.DatabaseNodule {}

class _$DioClient extends _i96.DioClient {}
